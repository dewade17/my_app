...
import 'package:my_app/mahasiswa/detail_mahasiswa.dart';
import 'package:my_app/mahasiswa/mahasiswa_baru.dart';
  ...
  Future<void> _deleteData(String id) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _showSnackBar('Data berhasil Dihapus'); // Tampilkan SnackBar
        setState(() {});
      } else {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          GestureDetector(
            onTap: () {
              // Tambahkan logika navigasi Anda di sini, misalnya:
              Navigator.push(
                context,
